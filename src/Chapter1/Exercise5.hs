...
--
-- [Applicative] Program will recurse infinitely, as evaluation of the
-- arugments to test results in the evaluation of p ad infinitum
--
-- [Normal] Program will terminate successfully (printing 0) as p is never
-- evaluated
